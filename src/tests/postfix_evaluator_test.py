...
class TestPostfixEvaluator(unittest.TestCase):
    ...
    def test_basic_addition(self):
        ...
        self.assertEqual(self.calculation.result, 3.0)
    ...
    def test_basic_multiplication(self):
        ...
        self.calculation.result_rpn = '1 2 *'
        self.postfix_evaluator.evaluate(self.calculation)
        self.assertEqual(self.calculation.result, 2.0)
    ...
    def test_negative_values_1(self):
        ...
        self.postfix_evaluator.evaluate(self.calculation)
        self.assertEqual(self.calculation.result, 0.0)
    ...
    def test_basic_arithmetic_1(self):
        ...
        self.postfix_evaluator.evaluate(self.calculation)
        self.assertEqual(self.calculation.result, 250.0)
    ...
    def test_basic_arithmetic_2(self):
        ...
        self.postfix_evaluator.evaluate(self.calculation)
        self.assertEqual(self.calculation.result, 15625.0)
    ...
    def test_basic_arithmetic_4(self):
        ...
        self.postfix_evaluator.evaluate(self.calculation)
        self.assertEqual(self.calculation.result, 48.0)
