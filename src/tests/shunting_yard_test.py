...
class TestShuntingYard(unittest.TestCase):
    ...
    def test_negative_expression_5(self):
        """Test if the class converts the given expression to RPN correctly.'"""
        self.shunting_yard.convert(self.calculation.new('-(x*(-y^x))', 'x=2, y=2'))
        self.assertEqual(self.calculation.result_rpn, '2 -2 2 ^ * -(')

    def test_negative_expression_6(self):
        """Test if the class converts the given expression to RPN correctly.'"""
        self.shunting_yard.convert(self.calculation.new('-2^2'))
        self.assertEqual(self.calculation.result_rpn, '-2 2 ^')
